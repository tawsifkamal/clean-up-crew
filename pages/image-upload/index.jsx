...
//   return (
  ...
  //       <Flex
  //         className="HeaderBox"
  //         bg={userType === "user" ? "green.500" : "orange.500"}
  //         color={"black"}
  //         h="10vh"
  //         w="100vw"
  //       ></Flex>
...
const validateLocation = () =>{
  ...
  const handleSubmit = async () => {
      ...
      if (userType === 'contractor') {
        body.postId = router.query.postId;
      }

    //  console.log(body);
    //  console.log(JSON.stringify(body));
    const response = userType === 'user' ? (await axios.post("api/post/create", body))
      : (await axios.put("api/post/post-resolve", body));
    console.log(response);
  }
        ...
        <Flex my="4" flexDirection="column">
          <AspectRatio ratio={1} maxH="30vh" my="2">
            {uploadedFile ? (
              ...
              {userType === 'user' && <Input type='text' value={title} onChange={(e) => {setTitle(e.target.value);  }} />}
